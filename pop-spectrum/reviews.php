...
<html lang="en">
    <head>
        ...
        <meta property="og:description" name="description" content="PLACEHOLDER" />
        <meta property="og:image" content="/images/pop-spectrum/reviews/thumbnail.jpg">
        <meta property="og:image:height" content="451">
        <meta property="og:image:width" content="800">
        <meta property="og:url" content="/pop-spectrum/reviews.php">
        <meta property="og:type" content="portfolio"/>
        <meta property="fb:app_id" content="APPID"/>
        <link rel="image_src" href="/images/pop-spectrum/reviews/thumbnail.jpg" />
    ...
    <body id="page-top" class="index">
        ...
        <?php
            ...
            //Navigation (Pop Spectrum)
            require_once ($_SERVER["DOCUMENT_ROOT"]."/nav/popSpectrumNav.php");
        ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="intro-text">
                                <h1 class="name">Reviews (Pop Spectrum)</h1>
                                <hr class="star-light">
                            </div>         
                            ...
                            <div class="tab-content">
                                <div id="intro" class="tab-pane fade in active">
                                    ...
                                    <p class="mediaDesc">Back in 2013 I met Robyn and Brendan Barry-Cotter through the Anime Music Video (AMV) community. As we got to know each other they told me about the concept of <a href="https://www.youtube.com/user/PopSpectrum" target="_blank">Pop Spectrum</a>. Brendan envisioned it as a mixture of cultural interests not limited to the anime community and I was brought in as a content creator to help broaden the voice of the brand.</p>
                                    
                                    <p class="mediaDesc">This section includes the scripted reviews I did while working with Pop Spectrum. These were based on pre-prepared scripts that I went off of intercut with footage from the source material. I still would like to make more of these in the future, my time just became considerably more limited after I graduated college back in 2014 (in particular I at least want to make one more set of videos for Hannibal's final season).</p>
                                </div>
