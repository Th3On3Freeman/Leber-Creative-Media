                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="intro-text">
                                        ...
                                        <p class="mainText">One of the most controversial new shows this year, <i>13 Reasons Why</i> is the story about a teenage girl's suicide and how she planned for everyone else to cope with it. Based on the novel of the same name, it centers around one of her friends who is given a set of tapes that discuss the 13 reasons why Hannah Baker killed herself. It starts off a bit ridiculous and never really loses a constant nagging sense that the main character should talk to some adults about this (or at least skip to his tape!). It also doesn't help that the season feels extremely padded; there are entire episodes focused on entries on Hannah's list that border on ridiculous. However, as the show continues it gets stronger and more affecting, as the most important reasons come to light. The final episode has some moments that are hard to watch, and when the season debuted it made news because schools were actively encouraging students to not watch or talk about the material. There are multiple sides to this: the reasons given regarding the school's neglect are valid and warrant opening the door to conversation about this sensitive issue. However, this subject can also be extremely dangerous for anyone who's dealt with these kinds of issues personally. It's troubling that this show is going to have a second season because beyond some arbitrary measures taken to extend the story it feels like a closed book. We'll have to see if it ends up as shallow as it sounds (maybe the second season will tackle this newly presented issue instead of suicide?)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
